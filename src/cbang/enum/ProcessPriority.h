...
CBANG_ENUM_EXPAND(PRIORITY_INHERIT,  0)
CBANG_ENUM_EXPAND(PRIORITY_NORMAL,   1)
CBANG_ENUM_EXPAND(PRIORITY_IDLE,     2)
CBANG_ENUM_EXPAND(PRIORITY_LOW,      3)
CBANG_ENUM_EXPAND(PRIORITY_HIGH,     4)
CBANG_ENUM_EXPAND(PRIORITY_REALTIME, 5)
