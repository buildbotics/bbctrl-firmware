...
def GenerateNinja(env, dest_file = 'build.ninja'):
    GenerateNinjaFile(env, dest_file)


def generate(env):
    env.CBAddVariables(('gen_ninja', 'Generate a build.ninja file', False))
    env.AddMethod(GenerateNinja)
