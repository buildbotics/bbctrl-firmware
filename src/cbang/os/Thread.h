...
namespace cb {
  ...
  class ThreadFunc : public Thread {
    ...
    void (T::*func)(); // pointer to member function
  ...
  public:
     ...
     * @param func A pointer to the member function.
     */
    ThreadFunc(T *obj, void (T::*func)()) : obj(obj), func(func) {}
